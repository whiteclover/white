t = {
    ...
    'username': 'Username',
    'username_explain': '',
    'username_missing': 'Please enter a username, must be  4-16 length can contains letter,digit, underscore',

    'password': 'Password',
    'password_explain': '',
    'password_invalid': 'Password must be must be  4-16 length can contains letter,digit, underscore',
    ...
    'recovery_message': 'You have requested to reset your password.' +
                'To continue follow the link below.' + '%s',
